<body>
    <div class="container">
        <div class="row">
            ...
            <h1 align="center" class="login-area">Retail Manager®</h1>
                <h3 align="center">Executive Management Panel</h3>
                        ...
                        <form role="form" action="<?php echo BASE_URL; ?>main/loginVerify/" method="POST">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Username" name="login" type="text" value="<?php echo (isset($_SESSION['temp'])? $_SESSION['temp']:''); ?>" autofocus>
                                </div>
                                <div class="form-group">
