                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr class="invoice-lg">
                            ...
                            <td></td>
                            <td>Total</td>
                            <td><?php echo $data['data']['info']['invoiceAmount']; ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="row">
                <table class="invoice-md" align="right">
                    <tr>
                        <td> <strong>Total: </strong> </td>
                        <td class="invoice-amount">  <?php echo $data['data']['info']['invoiceAmount']; ?> </td>
                    </tr>
                    <tr>
                        <td> <strong>Discount: </strong> </td>
                        <td class="invoice-amount"> <?php echo $data['data']['info']['invoiceDiscount']; ?> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="invoice-amount">  <?php echo $due; ?></td>
                    </tr>
                    <tr>
                        <td> <strong>Advance: </strong> </td>
                        <td class="invoice-amount">   <?php echo $adv; ?></td>
                    </tr>
